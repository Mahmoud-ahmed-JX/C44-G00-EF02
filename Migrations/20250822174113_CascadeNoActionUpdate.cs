...
{
    /// <inheritdoc />
    public partial class CascadeNoActionUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Crs_Ins", x => new { x.Inst_Id, x.Course_Id });
                    table.ForeignKey(
                        name: "FK_Crs_Ins_Courses_Course_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourRateBonus = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_St_Crs_Courses_Course_Id",
                        column: x => x.Course_Id,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_St_Crs_Students_Stud_Id",
                        column: x => x.Stud_Id,
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Crs_Ins_Instructors_Inst_Id",
                table: "Crs_Ins",
                column: "Inst_Id",
